...
@Component({
  ...
  template: `
    <div class="splash-overlay" [class.fade-out]="fadeOut" *ngIf="visible">
      <div class="splash-contenido" [class.zoom-in]="zoomed">
        <img
          [src]="modoOscuro ? 'assets/carpinchoN-avion.png' : 'assets/carpincho-avion.png'"
          alt="CarpinChill"
          class="splash-img"
          [class.vuela]="vuela"
          onerror="this.src='assets/carpincho-avion.png'"
        />
  ...
  styles: [`
    .splash-overlay {
      ...
      z-index: 9999; opacity: 1; transition: opacity 0.8s ease-out;
    }
    ...
    .splash-img {
      ...
      border-radius: 50%; background: white; padding: 12px; box-sizing: border-box;
    ...
    .splash-titulo h1 { font-size: 42px; margin: 0; font-weight: 800; text-shadow: 0 2px 8px rgba(0,0,0,0.3); }

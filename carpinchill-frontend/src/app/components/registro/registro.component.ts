...
@Component({
  ...
  `,
  styles: [`
    .pagina{display:flex;align-items:center;justify-content:center;min-height:80vh;padding:20px}
    .card{background:white;border-radius:16px;padding:36px 30px;width:100%;max-width:390px;box-shadow:0 4px 20px rgba(0,0,0,.1);text-align:center}
    .logo{font-size:46px;margin-bottom:6px}
    h1{font-size:22px;color:#1B4F72;margin:0 0 4px}
    ...
    .campo input{width:100%;padding:9px 11px;border:1px solid #ddd;border-radius:7px;font-size:13px;box-sizing:border-box}
    ...
    .link{color:#888;font-size:13px;margin:14px 0 0}
